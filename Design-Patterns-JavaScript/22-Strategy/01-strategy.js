...
Motivation. Many algorithms can be decomposed into higher and lowe level parts
...
/* A list can have some starting element in this example: <ul> and end element </ul>*/
class ListStrategy
{
    start(buffer) {}
    end(buffer) {}
...
class TextProcessor
{
    ...
    {
        this.buffer = []; //buffer
        this.setOutputFormat(outputFormat); //Which format output
    }
