/*
This example uses Promise.all() to ensure all the promises are resolved or rejected to then continue with the next code
*/
var MAINAPP = (function(nsp) {
    ...
    /*
    this code uses async await. Uses promise.all, that we await all three pieces of data without awaiting each individually which would take much longer.
    */
    ...
    (async function() {
        try {
            ...
            let results = await Promise.all([p1, p2, p3]); //wait for resolve all the promises
