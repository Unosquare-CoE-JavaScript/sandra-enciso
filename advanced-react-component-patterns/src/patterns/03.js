 ...
 * Comunicate the relationship between UI components and share impmicit state by leveraging an explicit parent-child relationship.
 * The parent component handles the UI state values and updates. State values are communicated from parent to child. (Typically with the context API)
 */
import React, {
  useState,
  useLayoutEffect,
