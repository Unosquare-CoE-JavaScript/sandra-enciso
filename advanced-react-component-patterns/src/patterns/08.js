 ...
 * Props collection refer to a collection of common props users of your components/hooks are likely to need. A collection -> typically an object
 */
/**
 * The Props Getters Pattern
 * Props getters, very much like props collection, provide a collection of props to users of your hooks/component.
 * The difference being the provision of a getter -a function invoked to return the collection of props.
 * The added advantage a prop getter has is it can be invoked with argumrnts to override or extend the collection of props returned.
 */
import React, {
  useState,
  useLayoutEffect,
...
const useClapState = (initialState = INITIAL_STATE) => {
  ...
  return { clapState, updateClapState, getTogglerProps, getCounterProps }; //returns an object of properties
};
...
/**
 * If the user wants to replicate exactly the same thing we've got in here, they're going to have to copy all and paste into usage,
 */
